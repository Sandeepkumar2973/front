...
import logo from '../images/sk.png';
        ...
        <div className='flip-card-back'>
          <ul className='sidebar-nav'>
            <li className='sidebar-nav-icons'>
              <a
                href='https://github.com/Sandeepkumar2973'
                rel='opener noreferrer'
                target='_blank'
            ...
            <li className='sidebar-nav-icons'>
              <a
                href='https://linkedin.com/in/sandeep-kumar-77710b231'
                rel='opener noreferrer'
                target='_blank'
            ...
            <li className='sidebar-nav-icons'>
              <a
                href='https://www.instagram.com/sk6450844/'
                rel='opener noreferrer'
                target='_blank'
            ...
            <li className='sidebar-nav-icons'>
              <a
                href='mailto:sandeepkumarcse49@gmail.com'
                rel='opener noreferrer'
                target='_blank'
            ...
            <li className='sidebar-nav-icons'>
              <a
                href='https://www.facebook.com/profile.php?id=100020259469192'
                rel='opener noreferrer'
                target='_blank'
